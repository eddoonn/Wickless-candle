...
class RepositoryContractTests(unittest.TestCase):
    def test_pine_scripts_enforce_fifteen_minutes_and_use_opening_side_rules(
        ...
        self.assertIn('originZoneAtrFraction = input.float(0.13', strategy)
        ...
        self.assertIn("touched and reclaimed and displacementValid and riskValid", strategy)
    ...
    def test_workflow_scans_on_fifteen_minute_schedule_and_uses_secret(
        ...
        self.assertIn("origin-zone reclaim entry", workflow)
